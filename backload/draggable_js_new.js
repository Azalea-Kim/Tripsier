    ...
    for(var i = 1; i <= days; i++) {
        ...
        tabs.addTab({
            ...
            html: "<div class='example example--outside'>"+
              ...
              "<div class='drag-zone plan-item' id='tab-"+i+"-2-attraction'></div>"+
              "<div class='drag-zone plan-item' id='tab-"+i+"-3-attraction'></div>"+
              "<div class='drag-zone plan-item' id='tab-"+i+"-4-attraction'></div>"+
              "<div class='drag-zone plan-item' id='tab-"+i+"-5-attraction'></div>"+
              "<div class='drag-zone plan-item' id='tab-"+i+"-6-attraction'></div>"+
              "</div>"
    ...
    for (var i = 1; i <= tabNum; i ++){
        ...
        for (var t = 1; t < planNodes.length; t++){
            if(t == 1){
                ...
                planNode = document.getElementById('tab-'+i+'-'+t+'-attraction');
            }
