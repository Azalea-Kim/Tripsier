...
def insert_test_attractions_ch1_ch2():
    ...
    Chongqing_Peoples_Square = Attraction(name="Chongqing_People's_Square",
                                          avatar=img_to_blob(root_pace + "001.png"), destination_id=1,
    ...
    Katsura_Garden = Attraction(name="Katsura_Garden",
                                avatar=img_to_blob(root_pace + "002.png"), destination_id=1,
    ...
    Shanghai_Disneyland = Attraction(name="Shanghai Disneyland", avatar=img_to_blob(root_pace + "005.png"),
                                     destination_id=3,
    ...
    Basilica_of_the_Sacred_Heart_of_the_Stone_Chamber = Attraction(
        ...
        location="No. 56-7, former Yide Road, Yuexiu District, Guangzhou, Guangdong Province", price="13$", score=5,tags = "3,2,5,7")
