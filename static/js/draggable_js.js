     ...
     $.ajax({
        ...
        success: function (res) {
            ...
            for (var i = 0; i < destinations.length; i++) {
                ...
                var string =
                            "<div class='drag-zone' id='draggable-container-destination-"+id+"'>"+
                                "<div class='draggable-form' style='width: 80%' id='draggable-task-destination-"+ id +"' draggable='true'>" +
     ...
     $.ajax({
        ...
        success: function (res) {
            ...
            for (var i = 0; i < attractions.length; i++) {
                ...
                var string =
                            "<div class='drag-zone' id='draggable-container-attraction-"+id+"'>"+
                                "<div class='draggable-form' style='width: 80%' id='draggable-task-attraction-"+ id +"' draggable='true'>" +
...
function submit(){
    ...
    for (var i = 1; i <= tabNum; i ++){
        ...
        destination="";
        attraction="";
        var tab = document.getElementById('tab'+i).firstChild;
        ...
        // "1:acc1,attr2||2:acc1,attr3,attr4||3:acc2,attr5,attr6,attr7
        text = text + destination + attraction + "||";
    }
